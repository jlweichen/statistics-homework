...
proc freq;
tables smoke*low_bt / nocol nopct chisq measures;
Title 'proc freq with mantel haenszel odds ratio estimate';
Title2 'smoking vs low birth weight unstratified';


proc freq;
tables race*smoke*low_bt / nocol nopct cmh chisq measures;

Title 'proc freq with mantel haenszel odds ratio estimate';
Title2 'smoking vs low birth weight stratified by race';
run;
